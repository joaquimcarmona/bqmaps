...
// (i.e., <script src="https://storage.googleapis.com/bqmaps_public/cartPainel.js">)
        ...
        '<div id="menu">' + 
            '<table class="menu" style="border-collapse: collapse;">' +
                ...
                '<tr class="action">' +
                    '<td class="bgrd">' +
                        '<h3 class="bgrd">' +
                            'Colorir estações por número de cartões diferentes usados</h3></td>' +
                    '<td class="bgrd" style="padding-left: 7px">' +
                        '<button type="button" onclick="cartQuery()"> Colorir </button></td>' +
                    '<td class="bgrd" >' +
            ...
            '<table class="serv">' +
                '<tr>' +
                    '<td class="bgrd" style="vertical-align: top; text-align: left;">DSem:  </td>' +
                    '<td class="bgrd"><input type="text" id="Tipo"></td>' +
                    '<td class="bgrd" style="vertical-align: top; width: 90px;">' +
                        '<button style="padding: 1px 23px"' +
                        'type="button" title="Colorir estações em função do número de etapas" onclick="odeSP()">' +
                        ' OD Et </button></a></td>' +
                '</tr>' +
                '<tr>' +
                    ...
                    '<td class="bgrd" style="width: 75px">' +
                        '<button style="padding: 1px 23px"' +
                        'type="button" title="Colorir estações em função do número de viagens" onclick="odvSP()">' +
                        ' OD Vi </button></a></td>' +
                '</tr>' +
                '<tr>' +
                    '<td class="bgrd" style="text-align: left;">Meses:  </td>' +
                    '<td class="bgrd"><input type="text" id="Meses" value="9"></td>' +
                    '<td class="bgrd">' +
                        '<button style="padding: 1px 25px"' +
                        'type="button" title="Colorir troços em função do número de validações"' +
                        'onclick="valSP()"> Valid </button></a></td>' +
                '</tr>' +
                '<tr>' +
                    '<td class="bgrd" style="text-align: left;"></td>' +
                    '<td class="bgrd" style="text-align: left;"></td>' +
                    '<td class="bgrd">' +
                        '<button style="padding: 1px 31px"' + 
                        'type="button" title="Colorir estações em função dda procura e da oferta"' +
                        'onclick="pompSP()"> PO </button></a></td>' +
                '</tr>' +
                '<tr>' +
                    '<td class="bgrd" style="text-align: left; padding-bottom: 10px">DMês:  </td>' +
                    '<td class="bgrd" style="padding-bottom: 10px">' +
                        '<input type="text" id="DMes">' +'</td>' +
                    '<td class="bgrd" style="padding-bottom: 10px">' +
                        '<button style="padding: 1px 26px"' + 
