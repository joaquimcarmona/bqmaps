...
// (i.e., <script src="https://storage.googleapis.com/bqmaps_public/odvPainel.js">)
...
// constrói o painel de input do serviço ode
    const menu = 
        '<div id="menu">' + 
            '<table class="menu" style="border-collapse: collapse;">' +
                '<tr class="help"><td class="bgrd"></td>' +
                    '<td class="bgrd" style="padding-left: 30px">' +
                        '<a class="bgrd" href="                    <td style="padding-left: 30px"><a href="https://docs.google.com/presentation/d/1XPkErss7k0pegyRr1ZfnUxdgTS1RWgLQOOcLmtyX-P0/edit?usp=sharing">' +
                        '<button style="padding: 1px 15px"' +
                                'type="button"> Ajuda </button></a></td>' +
                    '<td class="bgrd">' +
                        '<a href="https://docs.google.com/presentation/d/1PRA_dtHwrkW8n_84TNLQJqZ6CPhMdDMriB0ZMlEFj2k/edit?usp=sharing">' +
                        '<button type="button"> Help </button></a></td>' +
                '</tr>' +
                '<tr class="action">' +
                    '<td class="bgrd">' +
                        '<h3 class="bgrd">' +
                            'Colorir estações em função do número de viagens </h3></td>' +
                    '<td class="bgrd" style="padding-left: 30px">' +
                        '<button style="padding: 1px 12px" ' +
                                'type="button" onclick="odvQuery()"> Colorir </button></td>' +
                    '<td class="bgrd" >' +
            ...
            '<table class="serv">' +
                '<tr>' +
                    '<td class="bgrd" style="text-align: left; vertical-alignment: top">Dias:  </td>' +
                    '<td class="bgrd" style="vertical-alignment: top;">' +
                        '<input type="radio" id="todos" name="dias" value="Todos">' +
                        '<span style="vertical-alignment: top;"> Todos</span>' +
                        '<input type="radio" id="uteis" name="dias" value="Úteis" checked="checked">' + 
                        '<span style="vertical-alignment: top;"> Úteis</span></td>' +
                '</tr>' +
                '<tr>' +
                    ...
                    '<td class="bgrd" style="width: 75px">' +
                        ...
                        'type="button" title="Colorir estações em função do número de etapas" onclick="odeSP()"> OD Et </button></a></td>' +
                    '<td class="bgrd" >' +
                        '<button style="padding: 1px 9px"' +
                ...
                '<tr>' +
                    ...
                    '<td class="bgrd" >' +
                        '<input type="text" id="Meses" value="2"></td>' +
                    '<td class="bgrd">' +
                ...
                '</tr>' +
                '<tr>' +
                    '<td class="bgrd">Viagens com:  </td>' +
                    '<td class="bgrd">' +
                        '<input type="radio" id="or" name="od" value="Origem" checked="checked">' +
                        '<span style="vertical-alignment: top;"> Origem</span>' +
                        '<input type="radio" id="de" name="od" value="Destino">' +
                        '<span style="vertical-alignment: top;"> Destino</span></td>' +
                '</tr>' +
                '<tr>' +
                    '<td class="bgrd">' +
                        'Na estação n.º:   </td>' +
